...
For these synthetic circuits, the "velocity" is the analytic dx/dt rather than an
estimate from an RNA velocity tool, which is what makes the recovery check clean:
it isolates the optimizer from velocity estimation error.
"""
